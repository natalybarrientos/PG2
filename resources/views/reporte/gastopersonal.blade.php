...
@section('title', 'Reporte Gasto Personal')

@section('content_header')
<font face="Copperplate">
<h1 class="text-dark text-center font-medium"> G A S T O</h1>
<h1 class="text-dark text-center font-medium"> P E R S O N A L</h1>
<br>
<br>
</font> 
...
<div class="container center col-md-5 col-md-offset-5" >
    ...
    <!-- Fecha de inicio -->
        <div class="mb-3" >
            ...
            <input id="fechaini" name="fechaini" type="date" class="form-control" require tabindex="5">
        </div>
        @error('fechaini')
    ...
    <!-- Fecha de fin -->
        <div class="mb-3" >
            ...
            <input id="fechafin" name="fechafin" type="date" require class="form-control" tabindex="5">
        </div>
        @error('fechafin')
         <div class="alert alert-danger">{{ $message }}</div>
        @enderror

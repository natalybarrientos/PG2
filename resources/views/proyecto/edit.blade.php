...
<div class="container center col-md-5 col-md-offset-5">
    ...
    <!-- Costo -->
        <div class="mb-3">
            ...
            <input id="costo" name="costo" type="number" step="0.01" min="0" class="form-control" value="{{$proyecto->costo}}">
        </div>
        @error('costo')
         <div class="alert alert-danger">{{ $message }}</div>
        @enderror
    ...
    <!-- Botones -->
        ...
        <a href="/proyectos" class="btn btn-danger" tabindex="5"><i class="fa-solid fa-xmark"></i> | Cancelar</a>

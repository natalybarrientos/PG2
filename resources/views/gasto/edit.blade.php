...
@section('title', 'Gastos Maquinarias Multiservicios M&G')
...
<div class="container center col-md-5 col-md-offset-5">
    ...
    <!-- Costo -->
        <div class="mb-3">
            ...
            <input id="costo" name="costo" type="number" step="0.01" min="0" class="form-control" value="{{$gasto->costo}}">
        </div>
        @error('costo')
         <div class="alert alert-danger">{{ $message }}</div>
        @enderror
    ...
    <!-- Fecha de gasto -->
        <div class="mb-3">
            ...
            <input id="fecha" name="fecha" type="date" max="{{$fecha}}" class="form-control" value="{{$gasto->fecha}}">
        </div><br>
    ...
    <!-- Botones -->
        ...
        <a href="/gastos" class="btn btn-danger" tabindex="5"><i class="fa-solid fa-xmark"></i> | Cancelar</a>
